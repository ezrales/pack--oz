...
do
    ...
    echo "                                             "
    read -p " Enter Your number to Snffing & spoofing $ ~> " Spo
    echo "                                                     "
    echo "                                                     "
    ...
    ;;
    9)
    sudo apt-get install git && git clone git://git.kali.org/packages/isr-evilgrade.git
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    12)
    sudo apt-get install protos-sip
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    16)
    sudo apt-get install rtpinsertsound
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ;;
    17)
    sudo apt-get install rtpmixsound
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    22)
    sudo apt-get install sniffjoke
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "

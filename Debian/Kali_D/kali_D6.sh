...
do
    ...
    echo "                                             "
    read -p " Enter Your number to  Wireless Attacks & :> " WWWr
    echo "                                                     "
    echo "                                                     "
	case $WWWr in
	exit | back)
	...
	;;
	0)
	sudo apt-get install -y aircrack-ng asleap bluelog blueranger bluesnarfer bully cowpatty crackle eapmd5pass fern-wifi-cracker ghost-phisher giskismet gqrx kalibrate-rtl killerbee kismet mdk3 mfcuk mfoc mfterm multimon-ng pixiewps reaver redfang spooftooph wifi-honey wifitap wifite
	;;
	1)
    ...
    ;;
    4)
    sudo apt-get install git && git clone git://git.kali.org/packages/bluemaho.git
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ;;
    5)
    sudo apt-get install  git && git clone git://git.kali.org/packages/bluepot.git
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ;;
    6)
    sudo apt-get install blueranger
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    16)
    sudo apt-get install git && git clone git://git.kali.org/packages/gr-scan.git
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    18)
    sudo apt-get install killerbee
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "
    ...
    ;;
    28)
    sudo apt-get install rtlsdr-scanner
    echo "                           "
    echo "-------- finish -----------"
    echo "                           "
    read -s -p " press [Enter] key to continua.... "

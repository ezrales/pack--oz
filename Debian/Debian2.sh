...
do
    ...
    echo "                                             "
    read -p " Enter Your number to Install $ ~> " Hacking1
    echo "                                                     "
    echo "                                                     "
    ...
    ;;
    13)
    sudo apt-get install usbsniff
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    14)
    sudo apt-get install uperf 
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    15)
    ...
    ;;
    26)
    sudo apt-get install tcpreen
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    27)
    sudo apt-get install afftools
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    28)
    ...
    ;;
    29)
    sudo apt-get install metasploit-freemwork || 
    echo "                              " && 
    ...
    ;;
    31)
    sudo apt-get install argus-clients
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    32)
    ...
    ;;
    35)
    sudo apt-get install bannergrab
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    36)
    ...
    ;;
    #40)
    #sudo apt-get install "Headless Management"
    #echo "-------- finish -----------"
    #read -s -p " press [Enter] key to continua.... "
    #;;
    41)
    ...
    ;;
    51)
    sudo apt-get install openscap-scanne
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    52)
    ...
    ;;
    65)
    sudo apt-get install pcp-system-tools
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    66)
    ...
    ;;
    94)
    sudo apt-get install security-menus
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    95)
    ...
    ;;
    102)
    sudo apt-get install sucrack
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    103)
    sudo apt-get install ciphertest
    echo "-------- finish -----------"
    read -s -p " press [Enter] key to continua.... "
    ;;
    104)
